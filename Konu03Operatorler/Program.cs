namespace Konu03Operatorler
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("sayı 1 sayı 2 ye eşit mi? ve sayı 1 sayı 2 den küçük mü? " + ((sayi1 == sayi2) || (sayi1 < sayi2))); // şartlardan 1 tanesi true olması durumunda geri dönüş değeri true olur, tüm şartlar false ise false döner
            Console.WriteLine("sayı 1 sayı 2 ye eşit mi? ve sayı 1 sayı 2 den küçük mü? " + ((sayi1 == sayi2) || (sayi1 < sayi2))); // şartlardan 1 tanesi true olması durumunda geri dönüş değeri true olur, tüm şartlar false ise false döner
        }
    }
}
